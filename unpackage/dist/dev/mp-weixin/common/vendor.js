...
function getBooking(id) {
  return (0, _request.default)({
    method: "GET", // 请求方式
    url: "/api/miniapp/getBookingOrder/".concat(id) // 请求url
  });
}
...
function serviceTime(id) {
  return (0, _request.default)({
    method: "GET", // 请求方式
    url: "/api/miniapp/serviceTime/".concat(id) // 请求url
  });
}
...
function postBooking(params) {
  return (0, _request.default)({
    method: "POST", // 请求方式
    url: "/api/miniapp/booking/".concat(params.storeId), // 请求url
    data: params });
...
function getStoreInfo(id) {
  return (0, _request.default)({
    method: "GET", // 请求方式
    url: "/api/miniapp/getStoreInfo/".concat(id) // 请求url
  });
}
...
function cancelBookingOrder(id) {
  return (0, _request.default)({
    method: "GET", // 请求方式
    url: "/api/miniapp/cancelBookingOrder/".concat(id) // 请求url
  });
}
...
function getContact(id) {
  return (0, _request.default)({
    method: "GET", // 请求方式
    url: "/api/miniapp/get_contact_by_openid/".concat(id) // 请求url
  });
}
